...
function scene:show( event )
    ...
    if ( phase == "will" ) then
    	...
    	--Background
   		local background = display.newImageRect("./background1.jpg", 2048, 2000)
...
------------------------------------------------------------------------------------------------------------------------------
		...
		--The variables for the values of each card the player gets
		playerAmount3 = 0
		playerAmount4 = 0
		playerAmount5 = 0
		playerAmount6 = 0
		...
		--This function runs if the player pushes the hit button
	...
	--This function runs when the stand button is pushed
	local function standButtonTouch ( event )
		...
		if dealerCounter >= 1 then
			...
			dealerAmountText.text = ("Amount: "..dealerAmount1 + dealerAmount2)
			...
			if dealerAmount1 + dealerAmount2 < 17 then
				...
				dealerAmountText.text = ("Amount: "..dealerAmount1 + dealerAmount2 + dealerAmount3)
			...
			if dealerAmount1 + dealerAmount2 + dealerAmount3 < 17 then
				...
				--Updated dealer total text
				dealerAmountText.text = ("Amount: "..dealerAmount1 + dealerAmount2 + dealerAmount3 + dealerAmount4)
			...
			if dealerAmount1 + dealerAmount2 + dealerAmount3 + dealerAmount4 < 17 then
				...
				--Updated dealer total text
				dealerAmountText.text = ("Amount: "..dealerAmount1 + dealerAmount2 + dealerAmount3 + dealerAmount4 + dealerAmount5)
				...
				--Updated dealer total text
				dealerAmountText.text = ("Amount: "..dealerAmount1 + dealerAmount2 + dealerAmount3 + dealerAmount4 + dealerAmount5 + dealerAmount6)
		...
		timer.performWithDelay(1000, endGame)
				...
				--Calculating the total of the dealer
				dealerTotal = dealerAmount1 + dealerAmount2 + dealerAmount3 + dealerAmount4 + dealerAmount5 + dealerAmount6

		--This text shows up at the end of the game to show you the outcome of the match
		endText = display.newText( "", 160, 240, native.systemFont, 40 )
		endText:setFillColor( 255/255, 255/255, 255/255 )
		



		--this function activates when the game determines a winner 
		function endGame()
			
			--This happens when the player is bust
			if playerTotal >= 22 then
				endText.text = ("You're Bust!")
				playerMoney = playerMoney - 10
				playerMoneyText.text = ("Money: $"..playerMoney)
				print("Player Money: "..playerMoney)
			end

			--This happens if the dealer wins the game
			if playerTotal < dealerTotal and dealerTotal < 22 then
			...
			if playerTotal > dealerTotal and playerTotal < 22 or dealerTotal >= 22 then
